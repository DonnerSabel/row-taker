...
from row_taker.gui.rendering.game_renderer import (
    PALETTE,
    SIDEBAR_DEBUG_BORDER_WIDTH,
    _draw_game_background,
    _draw_sidebar_debug_frame,
)


def test_temporary_game_background_uses_flat_board_and_sidebar_fills() -> None:
...
def test_sidebar_debug_frame_marks_the_complete_new_sidebar_boundary() -> None:
    geometry = compute_board_geometry(
        (980, 720),
        row_count=4,
        hand_card_count=10,
    ...
    border_point = (
        geometry.sidebar_rect.left + SIDEBAR_DEBUG_BORDER_WIDTH // 2,
